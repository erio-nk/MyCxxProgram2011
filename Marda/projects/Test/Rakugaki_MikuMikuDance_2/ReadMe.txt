========================================================================
    Win32 アプリケーション: Rakugaki_MikuMikuDance_2 プロジェクトの概要
========================================================================

この Rakugaki_MikuMikuDance_2 アプリケーションは、AppWizard により作成されました。

このファイルには、Rakugaki_MikuMikuDance_2 
アプリケーションを構成する各ファイルの内容の概要が含まれています。


Rakugaki_MikuMikuDance_2.vcxproj
...
Rakugaki_MikuMikuDance_2.vcxproj.filters
...
Rakugaki_MikuMikuDance_2.ico
    これは、アプリケーションのアイコン (32x32) として使用されるアイコン 
    ファイルです。
    このアイコンは、メイン リソース ファイル Rakugaki_MikuMikuDance_2.rc 
    にインクルードされます。

small.ico
    これは、アプリケーションのアイコンの小さいバージョン (16x16) を含むアイコン 
    ファイルです。 このアイコンは、メイン リソース ファイル Rakugaki_MikuMikuDance_2.rc 
    にインクルードされます。
...
StdAfx.h、StdAfx.cpp
    これらのファイルは、Rakugaki_MikuMikuDance_2.pch 
