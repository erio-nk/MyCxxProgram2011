========================================================================
    コンソール アプリケーション: Test_Network_Server プロジェクトの概要
========================================================================

この Test_Network_Server アプリケーションは、AppWizard により作成されました。

このファイルには、Test_Network_Server 
アプリケーションを構成する各ファイルの内容の概要が含まれています。


Test_Network_Server.vcxproj
...
Test_Network_Server.vcxproj.filters
...
StdAfx.h、StdAfx.cpp
    これらのファイルは、Test_Network_Server.pch 
